import { SettingsState } from "@/components/settings/drawer/types/types.ts";
import type { Theme } from "@mui/material/styles";
import { extendTheme } from "@mui/material/styles";

import type { ThemeLocaleComponents } from "../types/types.ts";
import {
  colorSchemes,
  components,
  customShadows,
...
/**
 * createTheme without @settings and @locale certificates.
 *
 ```jsx
